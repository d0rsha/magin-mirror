...
var config = {
	...
	modules: [
			...
			config: {
				calendars: [
					...
					},
					{
						...
						url:
              "webcal://www.webcal.fi/cal.php?id=99&format=ics&wrn=1&wp=1&wf=12&color=%23FF3100&cntr=se&lang=sv&rid=wc"
					},
					{
		...
		},
		{
			...
			config: {
				location: "Linköping",
				locationID: "8131853", //ID from http://bulk.openweathermap.org/sample/city.list.json.gz; unzip the gz file and find your city
